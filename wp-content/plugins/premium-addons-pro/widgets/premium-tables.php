	...
	protected function get_repeater_controls( $repeater, $condition = array() ) {
		...
		$repeater->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} {{CURRENT_ITEM}} span.premium-table-text' => 'color: {{VALUE}} !important;',
				),
				'condition' => array_merge( $condition, array() ),
			)
		);
		...
		$repeater->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .premium-table .premium-table-row th{{CURRENT_ITEM}}.premium-table-cell span.premium-table-text, {{WRAPPER}} .premium-table .premium-table-row td{{CURRENT_ITEM}}.premium-table-cell span.premium-table-text',
			)
		);
