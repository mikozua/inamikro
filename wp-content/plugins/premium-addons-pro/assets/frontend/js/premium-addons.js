    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        window.CBPFWTabs = function (t, settings) {
            ...
            self._show = function (tabIndex, tab) {
                ...
                if ($('.premium-mscroll-yes').length < 1)
                ...
                if ($activeContent.find(".premium-carousel-inner").length > 0) {

                    setTimeout(function () {

                        $activeContent.find(".premium-carousel-inner").slick("refresh");
            ...
            hotspots.tooltipster({
                ...
                functionReady: function (origin, tooltipObj) {
                    ...
                    if ($(tooltipObj.origin).find('.magnet-spot').length > 0)
                        $(tooltipObj.tooltip).css('cursor', 'none');
        ...
        var functionalHandlers = {
            ...
            // 'premium-unfold-addon.default': PremiumUnfoldHandler,
            ...
            'premium-facebook-feed.default': PremiumFacebookHandler,
