(function ($) {
    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        var PremiumKenBurnsHandler = function ($scope) {
            ...
            function generateKenBurns() {
                ...
                $.each(settings.slides, function (index, slide) {
                    ...
                    if ('undefined' == typeof slide["premium_kenburns_images" + suffix] || '' == slide["premium_kenburns_images" + suffix]['url'])
                        suffix = '';
                    ...
                    if (null !== slide["premium_kenburns_images"]["url"]) {
                        layout +=
                            ...
                            '" src="' +
                            slide["premium_kenburns_images" + suffix]["url"] +
        ...
        elementorFrontend.hooks.addAction("frontend/element_ready/container", PremiumKenBurnsHandler);
        elementorFrontend.hooks.addAction("frontend/element_ready/column", PremiumKenBurnsHandler);
