...
class Module extends Module_Base {
	...
	public function register_page_controls( $element ) {
		...
		$element->start_controls_section(
			...
			array(
				'label' => __( 'Refresh Preview Area', 'premium-addons-pro' ),
	...
	public function register_controls( $element ) {
		...
		$element->add_control(
			'premium_mscroll_start_note',
			array(
				'raw'             => __( 'First, we need to create the scene by adding animations.', 'premium-addons-pro' ),
				'type'            => Controls_Manager::RAW_HTML,
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
				'condition'       => array(
	...
	private function add_helpful_information( $element ) {
		...
		$docs = array(
			...
			'https://premiumaddons.com/docs/settings-not-saved-in-elementor-magic-scroll-addon/' => __( 'Fix Magic Scroll settings not being saved »', 'premium-addons-pro' ),
